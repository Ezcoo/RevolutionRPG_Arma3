...
while {true} do {
	...
	daylight_iDrugAlcoholLevel = daylight_iDrugAlcoholLevel - 0.1;
	daylight_iDrugHeroinLevel = daylight_iDrugHeroinLevel - 0.1;
	daylight_iDrugCannabisLevel = daylight_iDrugCannabisLevel - 0.1;
	daylight_iDrugAmphetamineLevel = daylight_iDrugAmphetamineLevel - 0.1;
	...
	resetCamShake;
	addCamShake [_iCamShakePower, 999999, _iCamShakeFrequency];
