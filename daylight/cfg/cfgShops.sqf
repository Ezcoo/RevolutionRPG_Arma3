...
daylight_cfg_arrGearItems			= [
	...
	[110016, 2, "U_I_G_resistanceLeader_F"],
	[110017, 2, "U_C_Journalist"],
	[110018, 2, "V_Press_F"],
	[110019, 2, "H_Booniehat_khk"],
	[110020, 2, "H_Cap_red"],
	[110021, 2, "H_Cap_blu"],
	[110022, 2, "H_Cap_oli"],
	[110023, 2, "H_Cap_tan_specops_US"],
	[110024, 2, "H_MilCap_gry"],
	[110025, 2, "H_Bandanna_surfer"],
	[110026, 2, "H_Bandanna_camo"],
	[110027, 2, "H_StrawHat"],
	[110028, 2, "H_Hat_blue"],
	[110029, 2, "H_Hat_tan"],
	[110030, 2, "H_Cap_press"],
	[110031, 2, "g_shades_black"],
	[110032, 2, "g_shades_blue"],
	[110033, 2, "g_shades_green"],
	[110034, 2, "g_shades_red"],
	[110035, 2, "g_sport_blackred"],
	[110036, 2, "g_sport_blackwhite"],
	[110037, 2, "g_sport_blackyellow"],
	[110038, 2, "g_sport_greenblack"],
	[110039, 2, "g_sport_checkered"],
	[110040, 2, "g_spectacles"],
	[110041, 2, "g_shades_tinted"],
	[110042, 2, "g_squares"],
	[110043, 2, "g_squares_tinted"],
	[110044, 2, "g_balaclava_blk"],
	[110045, 2, "g_bandanna_blk"],

	[50012, 2, "acc_flashlight"],

	// Backpacks
	[110046, 3, "B_AssaultPack_blk"],
	[110047, 3, "B_Bergen_blk"]
];
...
daylight_cfg_arrMerchants		= [
	...
	[
		["c_man_1", "", "h_cap_blk", "g_squares", "U_C_HunterBody_grn", ""],
	...
	// Gang area 1
	[
		["c_man_1", "", "", "G_Bandanna_blk", "U_BG_Guerilla2_3", "V_Rangemaster_belt"],
		"Gang Store",
	...
	// Weapon Shop
	[
		["c_man_1", "", "H_Cap_blk", "G_Aviator", "U_BG_Guerrilla_6_1", "V_Rangemaster_belt"],
		"Weapon Shop",
	...
	// Black market
	[
		["c_man_1", "", "H_Booniehat_khk", "G_Bandanna_aviator", "U_I_G_resistanceLeader_F", "V_Rangemaster_belt"],
		"Black Market",
	...
	// Export docks
	[
		["c_man_1", "", "h_cap_blk", "", "U_OG_Guerilla2_3", ""],
		"Export Docks",
...
daylight_cfg_arrMerchantsAutoBounty = [
	...
	[
		["c_man_1", "", "", "g_squares", "U_BG_Guerilla2_1", ""],
		"Sell Amphetamine",
...
_arrVehicleShops_cars_blufor = [
	...
	["SUV", "C_SUV_01_F",
		[
			["Police", "daylight\gfx\skins\suv.jpg"]
		],
...
_arrVehicleShops_air_blufor = [
	["WY-55 Hellcat", "I_Heli_light_03_unarmed_F",
		...
		{
			_this setObjectTextureGlobal [0, "#(argb,8,8,3)color(0.05,0.05,0.05,1)"];
		},
	15000, -1]
];
...
daylight_cfg_arrVehicleShops	= [
	...
	[
		...
		[3359.56,12895.3,5.76729],
		315,

		[3346.51,12889.6,4.89384],
		47,
	...
	// Car shop Kavala
	[
		["c_man_1", "", "h_cap_blk", "", "U_C_Driver_3", ""],
		"Car Shop",
